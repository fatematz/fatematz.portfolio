      ...
      <div className="w-full max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-9  ">
        ...
        <div className="flex-1 z-10 text-center md:text-left">
          ...
          <div className="flex items-center justify-center md:justify-start gap-4 flex-wrap">
            <Link href="#projects" className="text-[13px] font-semibold text-white bg-[#e63946] hover:bg-[#c1121f] px-7 py-3 rounded-full transition-all duration-200">
              View Projects
            </Link>
            <Link href="#contact" className="text-[13px] font-medium text-[#e63946] border border-[#e63946]/40 hover:bg-[#e63946]/10 px-7 py-3 rounded-full transition-all duration-200">
              Contact Me
            </Link>
          </div>

          <div className="flex items-center justify-center md:justify-start gap-3 mt-10">
            <span className="font-mono text-[14px] text-[#555] tracking-widest">find me</span>
            <div className="w-5 h-px bg-[#333]" />

            <Link href="https://github.com/fatematz" target="_blank" className="w-9 h-9 rounded-full border border-white/[0.08] flex items-center justify-center text-[#a0a0a0] hover:text-[#e63946] hover:border-[#e63946]/50 hover:bg-[#e63946]/10 transition-all">
            ...
            <Link href="https://www.linkedin.com/in/fatema-tuj-zohura07" target="_blank" className="w-9 h-9 rounded-full border border-white/[0.08] flex items-center justify-center text-[#a0a0a0] hover:text-[#e63946] hover:border-[#e63946]/50 hover:bg-[#e63946]/10 transition-all">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
